...
is-deeply get-psgi-response($app, 'POST', '/foo'), [404, ["Content-Type" => "text/html"], 'Not found'], 'route POST /foo does not exist';
is-deeply get-psgi-response($app, 'POST', '/bar'), [200, ["Content-Type" => "text/html"], Any],              'route POST /bar exists';
is-deeply get-psgi-response($app, 'GET', '/bar'),  [404, ["Content-Type" => "text/html"], 'Not found'], 'route GET /bar does not exist';
