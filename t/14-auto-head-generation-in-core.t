...
is-deeply get-psgi-response($p6w-app, 'GET',  '/a'),         [302, ["Content-Type" => "text/html", :Location('/123')], ''],     'route GET /a';
is-deeply get-psgi-response($p6w-app, 'HEAD', '/a'),         [302, ["Content-Type" => "text/html", :Location('/123')], ''],     'route GET /a';
