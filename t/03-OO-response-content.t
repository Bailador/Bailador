...
is-deeply get-psgi-response($app, 'POST', '/foo'),  [404, ["Content-Type" => "text/html"], 'Not found'],      'route POST /foo not found';
is-deeply get-psgi-response($app, 'GET',  '/bar'),  [404, ["Content-Type" => "text/html"], 'Not found'],      'route GET /bar not found';
