...
subtest {
    ...
    is-deeply %data<response>, [200, ["Content-Type" => "text/html;charset=UTF-8"], 'Foo from route'], 'route GET /';
    is %data<err>, '';
}, '/foo';
...
subtest {
    ...
    is-deeply %data<response>, [200, ["Content-Type" => "text/html;charset=UTF-8"], "Bar from template\n"], 'route GET /bar';
    is %data<err>, '';
}, '/bar';
...
subtest {
    ...
    is-deeply %data<response>, [200, ["Content-Type" => "text/html;charset=UTF-8"], "Qux from route"], 'route GET /qux';
    is %data<err>, '';
}, '/qux';
